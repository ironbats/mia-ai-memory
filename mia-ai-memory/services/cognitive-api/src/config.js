...
export const config = {
  ...
  chatAttachmentMaxBytes: integer("COGNITIVE_CHAT_ATTACHMENT_MAX_BYTES", 104857600, 1048576, 268435456),
  chatZipMaxEntries: integer("COGNITIVE_CHAT_ZIP_MAX_ENTRIES", 10000, 100, 50000),
  chatZipMaxUncompressedBytes: integer("COGNITIVE_CHAT_ZIP_MAX_UNCOMPRESSED_BYTES", 536870912, 1048576, 2147483648),
  chatAttachmentContextMaxBytes: integer("COGNITIVE_CHAT_ATTACHMENT_CONTEXT_MAX_BYTES", 524288, 32768, 4194304),
  chatAttachmentContextMaxFiles: integer("COGNITIVE_CHAT_ATTACHMENT_CONTEXT_MAX_FILES", 80, 8, 256),
  ...
  chatWorkspaceRequestMaxBytes: integer("COGNITIVE_CHAT_WORKSPACE_REQUEST_MAX_BYTES", 4194304, 1048576, 16777216),
  chatWorkspaceManifestMaxFiles: integer("COGNITIVE_CHAT_WORKSPACE_MANIFEST_MAX_FILES", 5000, 100, 20000),
  chatWorkspaceContextMaxFiles: integer("COGNITIVE_CHAT_WORKSPACE_CONTEXT_MAX_FILES", 28, 1, 80),
  chatWorkspaceContextMaxBytes: integer("COGNITIVE_CHAT_WORKSPACE_CONTEXT_MAX_BYTES", 1572864, 65536, 8388608),
  chatWorkspaceFileMaxBytes: integer("COGNITIVE_CHAT_WORKSPACE_FILE_MAX_BYTES", 2097152, 16384, 8388608),
  chatCodeChangeMaxOperations: integer("COGNITIVE_CHAT_CODE_CHANGE_MAX_OPERATIONS", 40, 1, 200),
  chatCodeChangeMaxFileBytes: integer("COGNITIVE_CHAT_CODE_CHANGE_MAX_FILE_BYTES", 2097152, 16384, 8388608),
  chatCodeChangeMaxTotalBytes: integer("COGNITIVE_CHAT_CODE_CHANGE_MAX_TOTAL_BYTES", 4194304, 65536, 16777216)
}
